...
a 2 × 5 field on the left — TR1/TR2, CV 1/2, IN L/R, OUT L/R, CV 3/4 —
so the panel's bottom row reads CV 3…CV 8 in one line (Arlo 09-07). Blue artwork: an E-mu-style solid blue band 2.5 mm wide bleeding off the
...
pairs independently. Each column of the left field has its own **BUS
1 / off / 2** switch (one "BUS" word centred between the two switches; E-mu called it KYBD) at the top (x 15.4 and 39.4, y 131.5): a **DPDT
